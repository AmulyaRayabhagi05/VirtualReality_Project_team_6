...
public class NPCInteractable : MonoBehaviour
{
    ...
    {
        Debug.Log($"[NPCInteractable] Start button clicked for {npcName}");
    ...
    {
        Debug.Log($"[NPCInteractable] End button clicked for {npcName}");
        ConversationManager.Instance?.EndConversation();
    }

    public void OnBecomeActive()
    {
        Debug.Log($"[NPCInteractable] {npcName} is now active");
    ...
    {
        Debug.Log($"[NPCInteractable] {npcName} is now inactive");
        SetIdleState();
    }
    ...
    private void SetIdleState()
    {
        ...
        if (statusLabel != null)
        {
            statusLabel.text = "Press Start to talk";
        }
    ...
    {
        if (conversationPanel == null || _playerHead == null)
        {
            return;
        }
    ...
    {
        if (conversationPanel == null || !conversationPanel.activeSelf || _playerHead == null)
        {
            return;
        }
